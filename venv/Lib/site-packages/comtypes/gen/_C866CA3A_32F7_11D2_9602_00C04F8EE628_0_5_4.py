...
__all__ = [
    ...
    'DISPID_SPAsItem', 'STCRemoteServer', 'SAFT16kHz8BitMono',
    'SAFT24kHz16BitMono', 'SVSFVoiceMask', 'ISpeechPhraseAlternate',
    'SPPROPERTYINFO', 'DISPID_SLWPronunciations', 'DISPID_SRRAudio',
    'ISpeechLexiconWord', 'SpeechSpecialTransitionType', 'IStream',
    'DISPID_SVPriority', 'DISPID_SVDisplayUI', 'DISPID_SASetState',
    'SAFT32kHz8BitStereo', 'DISPID_SVVoice',
    'DISPID_SpeechAudioBufferInfo', 'SINone', 'SAFTNoAssignedFormat',
    'SPPS_Unknown', 'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE10',
    'SPSSuppressWord', 'SVEViseme', 'DISPID_SRSCurrentStreamNumber',
    'SDKLDefaultLocation', 'SpeechRecoProfileProperties',
    'DISPID_SVEEnginePrivate', 'SPEI_RECO_OTHER_CONTEXT',
    'SECLowConfidence', 'ISpeechGrammarRuleStateTransitions',
    'SSFMCreate', 'DISPID_SDKDeleteKey', 'SAFT32kHz16BitStereo',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_RESERVED9',
    'DISPID_SPAStartElementInResult', 'SVP_15', 'SRTExtendableParse',
    'DISPID_SRRecognizer', 'DISPID_SGRSTRule', 'SVSFDefault',
    'ISpeechVoice', 'SPCT_COMMAND', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SGRSTNextState', 'SP_VISEME_10',
    'ISpeechRecognizerStatus', 'SpeechWordPronounceable',
    'ISpObjectWithToken', 'ISpeechPhraseProperties', 'LONG_PTR',
    'SPAR_Medium', 'DISPID_SWFEExtraData', 'SpeechVoicePriority',
    'SpeechRunState', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SOTDisplayUI', 'ISpEventSource', 'SPRS_INACTIVE',
    'SREPropertyStringChange', 'DISPID_SPILanguageId', 'SPRST_ACTIVE',
    'SAFT16kHz16BitStereo', 'SITooFast', 'SVP_20',
    'SpeechStreamSeekPositionType', 'DISPID_SDKCreateKey',
    'ISpPhoneticAlphabetConverter', 'SPSHT_Unknown',
    'SECFNoSpecialChars', 'DISPID_SPRs_NewEnum', 'SP_VISEME_2',
    'STSF_CommonAppData', 'DISPID_SGRSTPropertyName',
    'DISPID_SAEventHandle', 'SPLO_DYNAMIC', 'DISPID_SLPLangId',
    'SPRECOCONTEXTSTATUS', 'ISpeechResourceLoader',
    'DISPID_SVEVoiceChange', 'DISPID_SDKEnumValues',
    'ISpObjectTokenCategory', 'DISPID_SASCurrentSeekPosition',
    'SRTReSent', 'DISPID_SDKSetLongValue', 'SP_VISEME_20',
    'SPEI_SR_BOOKMARK', 'DISPID_SAFGuid', 'SPRST_NUM_STATES',
    'DISPID_SRRSetTextFeedback', 'Speech_StreamPos_RealTime',
    'SP_VISEME_18', 'SRTStandard', 'DISPIDSPTSI_SelectionLength',
    'SRSEDone', 'DISPID_SPIGetText', 'SP_VISEME_1',
    'SpeechVisemeFeature', 'DISPID_SVSRunningState',
    'DISPID_SVSVisemeId', 'SpeechTokenValueCLSID', 'SRSInactive',
    'DISPID_SpeechMemoryStream', 'DISPID_SPIStartTime',
    'DISPID_SpeechCustomStream', 'SDTRule', 'SAFT16kHz16BitMono',
    'SWPKnownWordPronounceable', 'DISPID_SLWsItem',
    'IEnumSpObjectTokens', 'ISpeechGrammarRuleState',
    'ISpeechCustomStream', 'DISPID_SAFGetWaveFormatEx',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_UNDEFINED', 'SVP_10',
    'SVSFPurgeBeforeSpeak', 'SpeechPropertyAdaptationOn',
    'SLODynamic', 'DISPID_SVGetAudioInputs', 'DISPID_SMSSetData',
    'DISPIDSPTSI_SelectionOffset', 'STCInprocServer',
    'DISPID_SPIEngineId', 'SGRSTTEpsilon', 'DISPID_SGRAttributes',
    'SWTAdded', 'DISPID_SGRId', 'SPSEMANTICERRORINFO',
    'SAFT8kHz16BitStereo', 'SPVPRIORITY', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechRecognizer', 'SPINTERFERENCE_TOOLOUD',
    'SAFTNonStandardFormat', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRSCurrentStreamPosition', 'SAFT22kHz16BitMono',
    'DISPID_SpeechLexicon', 'SPEVENTSOURCEINFO', 'SDKLLocalMachine',
    'DISPID_SABIEventBias', 'SPSVerb', 'SPINTERFERENCE_NONE',
    'DISPID_SRGetPropertyString', 'DISPID_SGRSTText',
    'SSSPTRelativeToEnd', 'DISPID_SLGenerationId',
    'ISpeechPhraseInfo', 'DISPID_SPPId', 'SVSFParseSsml',
    'DISPID_SLWWord', 'DISPID_SRCEBookmark', 'SPWORDPRONUNCIATION',
    'ISpStream', 'DISPID_SVEStreamEnd', 'DISPID_SGRSTPropertyId',
    'SPBINARYGRAMMAR', 'SpMMAudioIn', 'DISPID_SPRsItem',
    'SAFT44kHz8BitMono', 'ISpeechXMLRecoResult',
    'ISpeechObjectTokenCategory', 'SPCT_DICTATION', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGDictationUnload',
    'DISPID_SOTsItem', 'ISpRecognizer', 'DISPID_SOTGetAttribute',
    'ISpeechBaseStream', 'SASClosed', 'SpeechGrammarTagWildcard',
    'SPEI_SR_RETAINEDAUDIO', 'STSF_LocalAppData', 'DISPID_SPACommit',
    'DISPID_SPRText', 'DISPID_SpeechAudio', 'DISPID_SRCPause',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechAudioStatus',
    'DISPID_SWFEFormatTag', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTCEnumerateTokens', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRInitialState', 'DISPID_SGRSTType',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechRecognizerStatus',
    'SPEI_RESERVED2', 'SAFTCCITT_uLaw_22kHzMono', 'SpObjectToken',
    'SPVOICESTATUS', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SMSALineId', 'SpeechGrammarTagDictation',
    'SpeechCategoryAudioIn', 'eLEXTYPE_VENDORLEXICON',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_RESERVED5', 'SASPause',
    'SPWORD', 'ISpGrammarBuilder', 'SPPS_Noun', 'SVP_2',
    'DISPID_SMSADeviceId', 'SSFMCreateForWrite', 'SPWT_PRONUNCIATION',
    'SRCS_Enabled', 'DISPID_SPCIdToPhone',
    'DISPID_SRSetPropertyString', 'SITooLoud',
    'DISPID_SRGCmdLoadFromResource', 'SpeechTokenKeyAttributes',
    'DISPID_SGRsDynamic', 'SRAExport',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SGLexicalNoSpecialChars', 'SPSFunction',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPPsItem', 'SGSExclusive',
    'SP_VISEME_14', 'SVP_17', 'SPGS_EXCLUSIVE', 'DISPID_SRGCommit',
    'eLEXTYPE_PRIVATE17', 'SFTInput', 'ISpRecoCategory',
    'SAFTCCITT_uLaw_44kHzMono', 'SPSHORTCUTTYPE',
    'DISPID_SLRemovePronunciation', 'SPSHT_NotOverriden',
    'eLEXTYPE_RESERVED10', 'SPBO_AHEAD', 'SITooSlow',
    'SPDKL_CurrentUser', 'SVP_4', 'DISPID_SRRAudioFormat',
    'SpeechEngineProperties', 'DISPID_SPCLangId', 'SPCATEGORYTYPE',
    'DISPID_SGRsCount', 'SpeechRecoEvents',
    'DISPID_SPEEngineConfidence', 'DISPID_SDKGetStringValue',
    'DISPID_SPRulesCount', 'SpeechTokenKeyUI', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRRTStreamTime', 'SPEI_PHONEME', 'SAFT32kHz16BitMono',
    '_SPAUDIOSTATE', 'SpeechAudioFormatGUIDWave', 'SVSFParseSapi',
    'SRSActive', 'SpeechPartOfSpeech', 'SPEI_START_INPUT_STREAM',
    'SPEI_RECOGNITION', 'SP_VISEME_7', 'DISPID_SVSLastBookmark',
    'DISPID_SRAudioInputStream', 'SRTEmulated', 'SECFEmulateResult',
    'DISPID_SLWType', 'tagSPPROPERTYINFO', 'SREStateChange',
    'DISPID_SOTCategory', 'DISPID_SWFEBitsPerSample',
    'ISpeechPhraseAlternates', 'SDTReplacement', 'SDKLCurrentConfig',
    'SRAInterpreter', 'SPWT_LEXICAL', 'SpeechRuleState',
    'DISPID_SFSOpen', 'SpWaveFormatEx', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE7', 'SASStop', 'SVP_7',
    'ISpeechTextSelectionInformation', 'SpMMAudioEnum',
    'DISPID_SPRsCount', 'SDTDisplayText', 'SPSNotOverriden',
    'SRARoot', 'DISPID_SPPChildren', 'SpeechGrammarState',
    'SRAORetainAudio', 'SpeechPropertyResponseSpeed',
    'SAFTADPCM_11kHzStereo', 'SPEI_TTS_BOOKMARK', 'SP_VISEME_3',
    'SAFT44kHz16BitMono', 'ISpStreamFormat', 'SPSModifier',
    'SPEI_INTERFERENCE', 'DISPID_SASFreeBufferSpace',
    '_ISpeechRecoContextEvents', 'SPEI_RESERVED1', 'SPCONTEXTSTATE',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechVoice',
    'SPPHRASEELEMENT', 'DISPID_SLGetWords',
    'DISPID_SDKSetBinaryValue', 'SPINTERFERENCE_TOOSLOW', 'SpStream',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPRFirstElement',
    'DISPID_SRGDictationSetState', 'DISPID_SVSpeak',
    'DISPID_SVIsUISupported', 'DISPID_SPERequiredConfidence',
    'DISPID_SPIGrammarId', 'DISPID_SVSInputWordPosition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_LETTERTOSOUND', 'Speech_Max_Pron_Length',
    'SP_VISEME_12', 'STCInprocHandler', 'SpeechGrammarWordType',
    'DISPID_SPRDisplayAttributes', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVGetProfiles', 'SPXMLRESULTOPTIONS', 'DISPID_SVEWord',
    'SPEI_SR_PRIVATE', 'SECFIgnoreCase', 'SP_VISEME_13',
    'SECFDefault', 'DISPID_SPIRule', 'IInternetSecurityMgrSite',
    'DISPID_SRGState', 'SPDKL_DefaultLocation', 'DISPID_SRGRules',
    'SpInprocRecognizer', 'SPRECOSTATE', 'DISPID_SOTDataKey',
    'SPCS_DISABLED', 'ISpeechPhraseProperty', 'DISPID_SLPsItem',
    'DISPID_SGRSTWeight', 'SAFT32kHz8BitMono', 'DISPID_SPCPhoneToId',
    'SECNormalConfidence', 'DISPID_SRCERequestUI',
    'SpeechRuleAttributes', 'SpInProcRecoContext', 'SDTLexicalForm',
    'tagSTATSTG', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SpeechAudioFormat', 'SpeechCategoryPhoneConverters',
    'DISPID_SRGIsPronounceable', 'SPAS_PAUSE', 'SVPNormal',
    'SAFT22kHz8BitMono', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechRecoResult2', 'SVEPrivate', 'DISPID_SOTCId',
    'Speech_Max_Word_Length', 'DISPID_SVSInputSentencePosition',
    'SAFTDefault', 'SpeechVoiceSkipTypeSentence', 'SVP_3',
    'DISPID_SRSetPropertyNumber', 'tagSPTEXTSELECTIONINFO',
    'SAFT11kHz16BitStereo', 'DISPID_SFSClose',
    'SDA_No_Trailing_Space', 'SPFILEMODE', 'SAFT12kHz16BitMono',
    'SAFTADPCM_8kHzStereo', 'SREAudioLevel', 'DISPID_SDKGetlongValue',
    'SVP_5', 'SAFT48kHz16BitStereo', 'DISPID_SRRTLength',
    'SWTDeleted', 'DISPID_SPEs_NewEnum', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPFirstElement', 'SPWT_DISPLAY',
    'SRERecoOtherContext', 'SVSFNLPSpeakPunc',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPVPRI_ALERT',
    'DISPID_SRDisplayUI', 'DISPID_SPEsCount',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechTokenKeyFiles',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_RESERVED8',
    'DISPID_SpeechPhraseRules', 'ISpeechMMSysAudio',
    'ISpeechPhraseRule', 'ISpeechObjectTokens', 'DISPID_SVRate',
    'SVP_13', 'SpeechAddRemoveWord', 'SRSEIsSpeaking',
    'eLEXTYPE_PRIVATE19', 'ISpeechPhraseElement',
    'DISPID_SOTs_NewEnum', 'SAFT22kHz16BitStereo', 'SPSHT_EMAIL',
    'SVSFPersistXML', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPSHT_OTHER', 'DISPID_SRGetFormat', 'SAFTADPCM_22kHzMono',
    'SAFTGSM610_44kHzMono', 'SpVoice', 'SGPronounciation',
    'DISPID_SOTCSetId', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SLGetGenerationChange', 'DISPID_SDKOpenKey',
    'SPPS_Modifier', 'DISPID_SOTCreateInstance',
    'SPRST_INACTIVE_WITH_PURGE', 'SREStreamStart',
    'DISPID_SVSPhonemeId', 'DISPID_SPIGetDisplayAttributes',
    'SLTUser', 'DISPID_SPPName', 'SpeechRecoContextState',
    'DISPID_SPAPhraseInfo', 'SVP_19', 'SpTextSelectionInformation',
    'DISPID_SPPNumberOfElements', 'SSFMOpenForRead', 'SpFileStream',
    'SP_VISEME_9', 'SPAO_RETAIN_AUDIO', 'SpeechRecognitionType',
    'SP_VISEME_4', 'DISPID_SRRDiscardResultInfo', 'SBOPause',
    'SPVISEMES', 'DISPID_SGRSTsCount', 'SPDATAKEYLOCATION',
    'ISpeechPhraseInfoBuilder', 'SpeechAudioVolume',
    'DISPID_SPERetainedSizeBytes', 'SASRun', 'SPINTERFERENCE_NOISE',
    'SPINTERFERENCE_NOSIGNAL', 'SAFT22kHz8BitStereo',
    'DISPID_SRAudioInput', 'DISPID_SRCVoice', 'SPSERIALIZEDRESULT',
    'DISPID_SGRsItem', 'DISPID_SWFEAvgBytesPerSec', 'SpAudioFormat',
    'DISPID_SAFType', 'SPSNoun', 'SPLOADOPTIONS',
    'DISPID_SRRRecoContext', 'SVP_18', 'SGDSActive', 'SPEI_MAX_TTS',
    'SPPS_Noncontent', 'DISPID_SBSSeek', 'SAFTADPCM_8kHzMono',
    'SPEI_SOUND_START', 'SRSActiveAlways', 'SRAONone',
    'eLEXTYPE_RESERVED7', 'DISPID_SMSGetData', 'ISpNotifySource',
    'DISPID_SVGetVoices', 'DISPID_SWFEChannels', 'SPWF_INPUT',
    'ISpeechGrammarRules', 'DISPID_SGRSAddWordTransition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVSLastResult',
    'ISpLexicon', 'SpeechVoiceEvents', 'SRADynamic',
    'SPFM_CREATE_ALWAYS', 'SVF_Emphasis', 'DISPID_SVEViseme',
    'SpeechVisemeType', 'DISPID_SDKSetStringValue',
    'DISPID_SVEventInterests', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPPARTOFSPEECH', 'DISPID_SGRClear',
    'DISPID_SRCEEndStream', 'SVP_16', 'SPADAPTATIONRELEVANCE',
    'SVSFIsXML', 'SPFM_OPEN_READONLY', 'DISPID_SPRuleParent',
    'DISPID_SRStatus', 'SPSInterjection', 'eLEXTYPE_PRIVATE14',
    'ISpXMLRecoResult', 'SPVPRI_NORMAL', 'SVP_14',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpStreamFormatConverter',
    'DISPID_SVSkip', 'DISPID_SpeechMMSysAudio', 'SREAdaptation',
    'SREPrivate', 'SpeechLoadOption', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechDisplayAttributes', 'SDA_Consume_Leading_Spaces',
    'SPCT_SUB_DICTATION', 'DISPID_SPANumberOfElementsInResult',
    'SAFT11kHz16BitMono', 'DISPID_SVEPhoneme', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPConfidence', 'STSF_AppData', 'SAFTADPCM_22kHzStereo',
    'SPDKL_CurrentConfig', 'SVP_12', 'SPPS_NotOverriden',
    'DISPID_SPPsCount', 'SpShortcut', 'DISPID_SVAudioOutput',
    'SVEAllEvents', 'DISPID_SPRuleFirstElement',
    'SRSInactiveWithPurge', 'SPXRO_Alternates_SML', 'SPPS_LMA',
    'SP_VISEME_15', 'DISPID_SRRSaveToMemory', 'SPAR_Low',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpNullPhoneConverter',
    'ISpeechAudioBufferInfo', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechBaseStream', 'SAFTGSM610_11kHzMono', 'SPAUDIOSTATE',
    'DISPID_SRGetRecognizers', 'SPEI_HYPOTHESIS', '_RemotableHandle',
    'DISPID_SADefaultFormat', 'SPSEMANTICFORMAT', 'DISPID_SPPParent',
    'DISPID_SVSpeakStream', 'SAFT24kHz16BitStereo',
    'DISPID_SPRuleName', 'SPSTREAMFORMATTYPE', 'SGRSTTWildcard',
    'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE8', 'DISPID_SRProfile',
    'SPGS_ENABLED', 'SpeechPropertyComplexResponseSpeed',
    'ISpResourceManager', 'SRESoundEnd',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechPhraseElements',
    'DISPID_SGRAddResource', 'ISpeechPhraseRules',
    'SPTEXTSELECTIONINFO', 'DISPID_SLPs_NewEnum',
    'SPEI_FALSE_RECOGNITION', 'ISpSerializeState', 'SVP_9',
    'SPINTERFERENCE', 'WAVEFORMATEX', 'ISpeechRecoResultTimes',
    'DISPID_SASNonBlockingIO', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE2', 'DISPID_SLPPhoneIds', 'DISPID_SGRAddState',
    'SVSFIsNotXML', 'SPBO_TIME_UNITS', 'DISPID_SMSAMMHandle',
    'SPAO_NONE', 'SPRST_INACTIVE', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEAudioLevel', 'SPPHRASERULE', 'eLEXTYPE_USER',
    'SpNotifyTranslator', 'DISPID_SOTId', 'SPINTERFERENCE_TOOQUIET',
    'SPEI_VISEME', 'DISPID_SRCEEnginePrivate', 'DISPID_SLPsCount',
    'SITooQuiet', 'STSF_FlagCreate', 'SAFT44kHz8BitStereo',
    'DISPID_SVStatus', 'ISpeechRecognizer', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechAudio', 'SVPOver', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseRule', 'ISpRecognizer3',
    'DISPID_SpeechVoiceStatus', 'ISpeechPhraseReplacements',
    'DISPID_SPAs_NewEnum', 'DISPID_SPPValue', 'DISPID_SBSRead',
    'DISPID_SOTSetId', 'SVSFUnusedFlags', 'DISPID_SVEBookmark',
    'SpeechCategoryAudioOut', 'DISPID_SOTIsUISupported',
    'SPRECOGNIZERSTATUS', 'SpPhraseInfoBuilder', 'DISPIDSPTSI',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRSAddRuleTransition',
    'ISpShortcut', 'DISPID_SPRuleId', 'ISpeechLexicon',
    'SpeechBookmarkOptions', 'SpResourceManager',
    'ISpeechRecoContext', 'DISPID_SRState', 'SPEI_END_SR_STREAM',
    'ISpeechAudioStatus', 'DISPID_SLAddPronunciation',
    'SpeechTokenContext', 'eLEXTYPE_USER_SHORTCUT',
    'ISpeechRecoResultDispatch', 'IEnumString',
    'SPEI_TTS_AUDIO_LEVEL', 'SREStreamEnd',
    'SSSPTRelativeToCurrentPosition', 'SPBO_NONE',
    'SAFT12kHz8BitStereo', 'SpeechRegistryLocalMachineRoot',
    'SGRSTTDictation', 'SSTTWildcard', 'SPEI_VOICE_CHANGE',
    'SWPUnknownWordPronounceable', 'SpCustomStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SDKGetBinaryValue',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechStreamFileMode',
    'DISPID_SAStatus', 'DISPID_SpeechObjectTokens', 'SP_VISEME_17',
    'SREHypothesis', 'SPAR_High', 'SpeechAudioProperties',
    'DISPID_SPAsCount', 'SAFT24kHz8BitMono', 'ISpPhraseAlt',
    'ISpeechFileStream', 'SAFTGSM610_22kHzMono', 'SVEVoiceChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpPhoneConverter',
    'SRAImport', 'SVPAlert', 'DISPID_SRGReset',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRNumberOfElements',
    'DISPID_SOTGetDescription', 'eLEXTYPE_PRIVATE12',
    'SpeechDictationTopicSpelling', 'SPSERIALIZEDPHRASE',
    'SPWORDTYPE', 'SGRSTTRule',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechRecognizerState', 'DISPID_SpeechPhraseBuilder',
    'ISpDataKey', 'SAFTCCITT_uLaw_11kHzMono', 'SAFT8kHz8BitMono',
    'SpObjectTokenCategory', 'DISPID_SASState',
    'DISPID_SpeechGrammarRule', 'SpSharedRecoContext', 'SPEVENT',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechRecoResult',
    'SPPHRASEREPLACEMENT', 'DISPID_SRCCreateGrammar',
    'DISPID_SDKDeleteValue', 'DISPID_SCSBaseStream', 'SVEAudioLevel',
    'DISPID_SPPEngineConfidence', 'DISPID_SRGCmdLoadFromMemory',
    'eLEXTYPE_PRIVATE3',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SGRSTTTextBuffer', 'SREPropertyNumChange', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPEDisplayAttributes', 'SPEI_START_SR_STREAM',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SAVolume',
    'SPRECORESULTTIMES', 'ISpVoice', 'DISPID_SpeechRecoResultTimes',
    'SGLexical', 'SPRULE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPPS_Verb', 'SAFTText', 'DISPID_SLWs_NewEnum',
    'DISPID_SRIsShared', 'SAFTGSM610_8kHzMono', 'SPAUDIOOPTIONS',
    'SPLEXICONTYPE', 'SVSFNLPMask', 'DISPID_SPIProperties',
    'SPINTERFERENCE_TOOFAST', 'SPWF_SRENGINE', 'SPAR_Unknown',
    'DISPIDSPRG', 'DISPID_SRCState', 'SPEI_RESERVED6', 'SPWORDLIST',
    'SVF_Stressed', 'SGRSTTWord', 'SpSharedRecognizer', 'SVF_None',
    'DISPID_SVEAudioLevel', 'SAFT24kHz8BitStereo', 'ISpRecoGrammar',
    'SSTTDictation', 'SP_VISEME_8', 'SPEI_PHRASE_START',
    'DISPID_SVSInputSentenceLength', 'SPEI_MAX_SR', 'SREInterference',
    'SAFT48kHz8BitMono', 'SDTPronunciation', 'SRERecognition',
    'SpeechPropertyHighConfidenceThreshold', 'SPSMF_UPS', 'SLTApp',
    'SpeechAllElements', 'SPFM_OPEN_READWRITE',
    'DISPID_SPEAudioSizeBytes', 'ISpRecoContext2', 'SPAS_STOP',
    'SpeechAudioFormatType', 'DISPID_SRCSetAdaptationData',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPELexicalForm',
    'SPEI_MIN_SR', 'ISpeechWaveFormatEx',
    'DISPID_SRCCreateResultFromMemory', 'SAFT11kHz8BitStereo',
    'SpeechCategoryAppLexicons', 'DISPID_SVGetAudioOutputs',
    'ISpProperties', 'SPGS_DISABLED', 'DISPID_SVSpeakCompleteEvent',
    'SpUnCompressedLexicon', 'SVP_8', 'Speech_Default_Weight',
    'DISPID_SpeechPhraseReplacement', 'SpeechMicTraining',
    'DISPID_SpeechPhraseAlternates', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE16', 'SREPhraseStart', 'SDKLCurrentUser',
    'DISPID_SRCERecognition', 'DISPID_SRCEInterference',
    'ISpRecognizer2', 'SAFT48kHz16BitMono', 'SPPS_RESERVED3',
    'SBONone', 'SpeechPropertyResourceUsage', 'SRTAutopause',
    'DISPID_SpeechPhraseElement', 'SpeechCategoryVoices',
    'DISPIDSPTSI_ActiveOffset', 'SDTProperty', 'ISpRecoGrammar2',
    'DISPID_SRRGetXMLResult', 'DISPID_SRCEStartStream',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SRERequestUI',
    'SpeechEmulationCompareFlags',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_21',
    'ISpeechLexiconPronunciations', 'DISPID_SRCEPropertyNumberChange',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPERetainedStreamOffset',
    'SPSUnknown', 'DISPID_SPRules_NewEnum', 'SGDSInactive',
    'SAFT16kHz8BitStereo', 'DISPID_SLPSymbolic',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPEActualConfidence', 'SpeechFormatType',
    'SVSFIsFilename', 'ISpeechPhraseReplacement',
    'DISPID_SVEStreamStart', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRCBookmark', 'DISPID_SPPs_NewEnum', 'DISPID_SPEsItem',
    'SAFT8kHz16BitMono', 'SPEI_END_INPUT_STREAM',
    'SGDSActiveWithAutoPause', 'SAFTCCITT_ALaw_44kHzMono',
    'SPXRO_SML', 'DISPID_SRCEFalseRecognition',
    'DISPID_SWFESamplesPerSec', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechRecoResult', 'SGSDisabled',
    'DISPID_SPIReplacements', 'DISPID_SRRPhraseInfo',
    'SpeechPropertyNormalConfidenceThreshold', 'SpMMAudioOut',
    'SPDKL_LocalMachine', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT8kHz8BitStereo',
    'SPCT_SUB_COMMAND', 'SpeechVoiceSpeakFlags', 'SVP_6',
    'SVSFlagsAsync', 'SAFT44kHz16BitStereo', 'SpLexicon',
    'eLEXTYPE_PRIVATE15', 'IInternetSecurityManager',
    'ISpeechMemoryStream', 'DISPID_SABIBufferSize', 'DISPID_SRGId',
    'SPCT_SLEEP', 'DISPID_SGRsCommit', 'SpeechTokenShellFolder',
    'SVEWordBoundary', 'DISPID_SVSLastStreamNumberQueued',
    'SRESoundStart', 'ISpMMSysAudio', 'SVESentenceBoundary',
    'SpeechCategoryRecognizers', 'SRCS_Disabled',
    '__MIDL_IWinTypes_0009', 'DISPID_SWFEBlockAlign',
    'DISPID_SLWLangId', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPISaveToMemory', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPPS_Function', 'DISPID_SRSAudioStatus', 'SpeechUserTraining',
    'SpeechVoiceCategoryTTSRate', 'SDA_Two_Trailing_Spaces',
    'eLEXTYPE_RESERVED6', 'ISpRecoContext', 'eLEXTYPE_RESERVED4',
    'SpCompressedLexicon', 'DISPID_SRCESoundStart',
    'DISPID_SPIAudioStreamPosition', 'ISpNotifySink', 'SPRS_ACTIVE',
    'SWPUnknownWordUnpronounceable', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPRuleNumberOfElements', 'SPEI_RESERVED3',
    'ISpObjectToken', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCResume', 'SDTAll', 'ISpeechGrammarRuleStateTransition',
    'UINT_PTR', 'SSTTTextBuffer', 'DISPID_SOTRemove',
    'DISPID_SLWsCount', 'SVP_0', 'SAFT12kHz16BitStereo',
    'SpStreamFormatConverter', 'SVEBookmark', 'SECFIgnoreKanaType',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVPause',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCRecognizer',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPIElements',
    'SPWORDPRONUNCIATIONLIST', 'SRATopLevel', 'SpeechDiscardType',
    'DISPID_SRGRecoContext', 'SPGRAMMARSTATE', 'SPPS_RESERVED1',
    'DISPID_SBSFormat', 'DISPID_SGRSTsItem', 'SpeechLexiconType',
    'ISpeechLexiconWords', 'SDTAlternates', 'SPBOOKMARKOPTIONS',
    'ISpRecoResult', 'DISPID_SGRSTransitions',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVEPhoneme',
    'SPEI_WORD_BOUNDARY', 'SPPS_RESERVED4',
    'DISPID_SAFSetWaveFormatEx', 'ISequentialStream',
    'DISPID_SRSNumberOfActiveRules', 'Speech_StreamPos_Asap',
    'SPEI_PROPERTY_NUM_CHANGE', 'SGDisplay',
    'DISPID_SLGetPronunciations', 'DISPID_SABufferInfo',
    'SPEVENTENUM', 'SpeechAudioState', 'SREAllEvents',
    'SpeechEngineConfidence', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPARecoResult', 'DISPID_SpeechObjectToken',
    'SDA_One_Trailing_Space', 'DISPID_SVVolume',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechInterference',
    'SP_VISEME_19', 'SAFTADPCM_11kHzMono',
    'DISPID_SpeechXMLRecoResult', 'SPVPRI_OVER', 'SP_VISEME_0',
    'DISPID_SGRSRule', 'ISpeechObjectToken',
    'DISPID_SRCEventInterests', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechRecoContext', 'DISPID_SPRuleEngineConfidence',
    'SP_VISEME_5', 'SPEI_ADAPTATION', 'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechRecoContextEvents', 'SPPS_RESERVED2',
    'DISPID_SLPType', 'DISPID_SPRulesItem', 'DISPID_SRRTTickCount',
    'SREFalseRecognition', 'SpeechWordType', 'SGSEnabled',
    'ISpNotifyTranslator', 'DISPID_SVSInputWordLength', 'STCAll',
    'DISPID_SVESentenceBoundary',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPAUDIOSTATUS',
    'DISPID_SpeechGrammarRules', 'SPSHORTCUTPAIRLIST',
    'ISpPhoneticAlphabetSelection', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRCEPhraseStart', 'DISPID_SABIMinNotification',
    'SPGRAMMARWORDTYPE', 'SINoise', 'SAFTCCITT_ALaw_22kHzMono',
    'SECFIgnoreWidth', 'SLOStatic', 'DISPID_SGRsFindRule',
    'SREBookmark', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechLexiconPronunciation', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechLexiconPronunciation', 'SINoSignal',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechFileStream',
    'DISPID_SRRGetXMLErrorInfo', 'SDTAudio',
    'DISPID_SPRuleConfidence', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVEStartInputStream', 'DISPID_SpeechLexiconWord',
    '_ISpeechVoiceEvents', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPAUDIOBUFFERINFO', 'SPAS_RUN', 'SPEI_MIN_TTS',
    'eLEXTYPE_PRIVATE1', 'SPFM_CREATE',
    'DISPID_SpeechPhraseProperties', 'SpeechRegistryUserRoot',
    'ISpeechGrammarRule', 'SP_VISEME_11',
    'SpeechRetainedAudioOptions', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechDataKey', 'DISPID_SRCEPropertyStringChange', 'SVP_1',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTCDefault',
    'SP_VISEME_16', 'SPFM_NUM_MODES', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechGrammarRuleStateTransitionType',
    'SpPhoneticAlphabetConverter', 'SPAS_CLOSED',
    'DISPID_SRGDictationLoad', 'SPEI_REQUEST_UI', 'SVSFParseMask',
    'SPEI_SOUND_END', 'SGDSActiveUserDelimited', 'ISpPhrase',
    'ISpEventSink', 'SPWAVEFORMATTYPE', 'SSFMOpenReadWrite',
    'DISPID_SRCEAdaptation', 'SPPHRASE', 'SAFTCCITT_ALaw_22kHzStereo',
    'eWORDTYPE_ADDED', 'DISPID_SVResume', 'SVEEndInputStream',
    'DISPID_SRIsUISupported', 'DISPID_SRRAlternates',
    'SAFT12kHz8BitMono', 'SPSLMA', 'ISpeechAudioFormat',
    'DISPID_SRRTimes', 'ISpeechVoiceStatus', 'SP_VISEME_6',
    'ISpeechRecoGrammar', 'DISPID_SRCRequestedUIType',
    'DISPID_SOTCGetDataKey', 'DISPID_SREmulateRecognition',
    'SPPS_Interjection', 'SPSHORTCUTPAIR', 'DISPIDSPTSI_ActiveLength',
    'SECHighConfidence', 'DISPID_SRCEHypothesis', 'SVP_11',
    'SPCS_ENABLED', 'eWORDTYPE_DELETED', 'SpeechDataKeyLocation',
    'STCLocalServer', 'DISPID_SRGSetTextSelection',
    'eLEXTYPE_PRIVATE4', 'SSSPTRelativeToStart',
    'SVSFParseAutodetect', 'DISPID_SRSClsidEngine',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVAlertBoundary',
    'DISPID_SOTsCount', 'SRTSMLTimeout',
    'DISPID_SRSSupportedLanguages', 'SPRULESTATE',
    'DISPID_SRCRetainedAudio', 'DISPID_SDKEnumKeys',
    'DISPID_SRCESoundEnd', 'SPBO_PAUSE', 'DISPID_SPIAudioSizeTime',
    'SAFT11kHz8BitMono', 'DISPID_SPEPronunciation',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechPhoneConverter', 'DISPID_SBSWrite', 'SPLO_STATIC',
    'SRADefaultToActive', 'ISpAudio', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVWaitUntilDone',
    'DISPID_SPEDisplayText', 'SAFTExtendedAudioFormat', 'SFTSREngine',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRSpeakAudio',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechVoiceEvent', 'SPEI_SENTENCE_BOUNDARY',
    'SPPS_SuppressWord', 'SP_VISEME_21', 'DISPID_SGRName',
